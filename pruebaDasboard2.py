...
# Definir el callback para cambiar entre dashboards
...
def dashboard1_layout():
    with DataBase() as db:
        ...
        # Create figures with bar charts
    ...
    return html.Div([
        ...
        # First Dropdown and Graph (Discount)
        html.Div([
    ...
    ], id='dashboard1-content')  # Set a unique ID for the Div
...
def update_graph_descuento(selected_tipo_descuento, selected_envio_baratos):
    with DataBase() as db:
        ...
        # Filter discount data based on selected type
        ...
        # Unique types for color map in discount
        tipos_disponibles_descuento = filtered_data_descuento['Tipo'].unique()

        # Update discount figure with new data and color map
        ...
        # Filter cheap data based on selected shipping type
        ...
        # Unique shipping types for color map in cheap
        envios_disponibles_baratos = filtered_data_baratos['Envio'].unique()

        # Update cheap figure with new data and color map
        fig_baratos = px.bar(
